...
import { type RecoverySession, updatePassword } from "@/siteman-lib/supabaseAuth";
        ...
        <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: "36px 40px 52px", background: "linear-gradient(0deg, rgba(0,0,0,0.92) 0%, transparent 100%)" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "14px" }}>
            <div style={{ width: "36px", height: "36px", display: "flex", alignItems: "center", justifyContent: "center" }}>
              <img src="/siteman/logo_b.png" alt="Logo" style={{ width: "100%", height: "100%", objectFit: "contain" }} />
            </div>
