...
import { signInWithPassword } from "@/siteman-lib/supabaseAuth";
...
export default function LoginPage({ onForgotPassword }: LoginPageProps) {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      document.cookie = "persona=site-manager; path=/; max-age=86400";
      setIsTransitioning(true);
      window.setTimeout(() => {
        router.push("/siteman/dashboard");
      }, 650);
    } catch (error) {
      setErrorMessage(
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ marginTop: "auto", paddingTop: "20px", display: "flex", justifyContent: "center", alignItems: "center" }}>
          <span style={{ fontSize: "11px", color: "#94a3b8", textAlign: "center" }}>
            For Support Please Contact: bayanihubenterpise@gmail.com
          </span>
        </div>
      </div>
    </div>
