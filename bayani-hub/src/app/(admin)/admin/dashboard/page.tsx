      ...
      <main className={styles.main}>
        ...
        <section className={styles.quickAccessSection}>
          ...
          <div className={styles.quickAccessGrid}>
            ...
            <QuickAccessCard
              ...
              description="View and manage all donor profiles and review history"
        ...
        <section className={styles.quickAccessSection}>
          ...
          {recentActivity.length > activityPageSize && (
            <div style={{ display: "flex", justifyContent: "flex-end", alignItems: "center", gap: "0.5rem", padding: "0.75rem 1rem 0" }}>
              <button
                onClick={() => setActivityPage((page) => Math.max(1, page - 1))}
                disabled={activityPage === 1}
                style={{ border: "1px solid #E5E5E5", background: "white", borderRadius: "0.375rem", padding: "0.35rem 0.6rem", cursor: activityPage === 1 ? "not-allowed" : "pointer" }}
              >
                Previous
              </button>
              ...
              <button
                ...
                style={{ border: "1px solid #E5E5E5", background: "white", borderRadius: "0.375rem", padding: "0.35rem 0.6rem", cursor: activityPage === activityTotalPages ? "not-allowed" : "pointer" }}
              >
                Next
              </button>
            </div>
