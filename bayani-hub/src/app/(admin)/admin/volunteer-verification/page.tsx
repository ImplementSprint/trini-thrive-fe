...
export default function VolunteerVerification() {
    ...
    try {
      ...
      const results: Volunteer[] = (profiles ?? []).map((p: any) => {
        ...
        return {
          ...
          name,
          email: p.email ?? "",
          status: isVolunteer ? "verified" : "pending",
          joinDate: "",
          rating: isVolunteer ? 4.5 : 0,
          hoursLogged: isVolunteer ? "Active volunteer" : "Pending volunteer verification",
  ...
  const stats = {
    ...
    inactive: allVolunteers.filter((v) => v.status === "inactive").length,
  };
    ...
    <div className={styles.container}>
      ...
      <main className={styles.mainContent}>
        ...
        <div className={styles.inlineLegend}>
          <span><i style={{ backgroundColor: "#22c55e" }} /> Verified Volunteer</span>
          <span><i style={{ backgroundColor: "#eab308" }} /> Pending Verification</span>
          <span><i style={{ backgroundColor: "#9ca3af" }} /> Inactive</span>
        </div>
