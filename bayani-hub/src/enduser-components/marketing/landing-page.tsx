        ...
        <section className={styles.content}>
          <div className={styles.heroBlock}>
            ...
            <div className={styles.actions}>
              {token ? (
                <Link className={styles.primaryAction} href="/enduser/dashboard">
                  Go to Dashboard
                </Link>
              ) : (
                <>
                  <Link className={styles.primaryAction} href="/enduser/login">
                    Log In
                  </Link>
                  <Link className={styles.secondaryAction} href="/enduser/signup">
                    Sign Up
                  </Link>
                </>
              )}
            </div>
            <p className={styles.inquiryLine}>
              For inquiries contact: bayanihubenterpise@gmail.com
            </p>
          </div>
        </section>
      </div>
