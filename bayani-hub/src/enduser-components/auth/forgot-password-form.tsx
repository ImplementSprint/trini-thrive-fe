...
export function ForgotPasswordForm() {
  ...
  // Verify OTP via real backend endpoint
  const handleVerifyOtp = async () => {
    ...
    try {
      const res = await fetch(`${API_BASE}/auth/verify-otp`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ email: identifier.trim(), code: joinedOtp }),
      });
  ...
  const handleResetPassword = async () => {
    ...
    try {
      const res = await fetch(`${API_BASE}/auth/reset-password`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ email: identifier.trim(), otp: joinedOtp, newPassword }),
      });
        ...
        <section className={`${styles.shell} ${styles.successShell}`}>
          ...
          <div className={`${styles.card} ${styles.successCard}`}>
            ...
            <div className={styles.successIconWrap}>
              <Image
                src="/enduser/icons/password reset.png"
            ...
            <button className={styles.button} type="button" onClick={() => router.push("/enduser/login")}>
              Back to Log In
            </button>
          </div>
        </section>
          ...
          <div className={styles.contentGrid}>
            <div className={styles.textColumn}>
              <div className={styles.formBlock}>
                ...
                >
                  <Image
                    src="/enduser/icons/Arrow left.png"
                    alt="Back arrow"
                    width={22}
                    height={22}
                    ...
                    <div className={styles.socialWrap}>
                      ...
                      <div className={styles.socialRow}>
                        <button className={styles.googleButton} type="button">
                          <Image src="/enduser/icons/google.png" alt="Google" width={20} height={20} />
                ...
                {step === "otp" ? (
                  <>
                    ...
                    <button className={styles.button} type="button" onClick={handleVerifyOtp} disabled={isLoading}>
                ...
                {step === "request" ? null : (
                  <Link className={styles.loginLink} href="/enduser/login">
                    Back to login
                  </Link>
                )}
              </div>
            ...
            <div className={styles.visualWrap} aria-hidden="true">
              ...
              <Image
                src="/enduser/images/Forgot Password (Big Rectangle).png"
                alt=""
                width={276}
                height={337}
              ...
              />
              <Image
                src="/enduser/images/Forgot Password (Small Rectangle).png"
                alt=""
                width={171}
                height={127}
