...
function ResourceMapPage({ incidents, units, onUpdate, dispatchTarget, onClearDispatchTarget, onDispatchConfirmed }: {
  ...
  const confirmDispatch = () => {
    ...
    setMapKey(k => k + 1);
    toast.show("Dispatch confirmed — redirecting to Rescue Monitoring");
    // Navigate to Rescue Monitoring page
...
function Shell({ onLogout }: { onLogout: () => void }) {
  ...
  useEffect(() => {
    ...
    link.type = "image/png";
    link.href = "/Main-Logo-removebg-preview.png";
  }, []);
        ...
        <header className="dp-topbar">
          <div className="dp-topbar-left">
            ...
            <img
              ...
              alt="Damayan Logo"
              style={{ height: 36, width: "auto", objectFit: "contain", marginRight: "0.5rem", flexShrink: 0 }}
            />
